/*!
 * artplayer-plugin-danmuku.js v4.4.1
...
!function (t, e, n, i, r) {
    var a = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : "undefined" != typeof window ? window : "undefined" != typeof global ? global : {},
        o = "function" == typeof a.parcelRequire93cf && a.parcelRequire93cf, s = o.cache || {},
    ...
    l.isParcelRequire = !0, l.Module = function (t) {
        this.id = t, this.bundle = l, this.exports = {}
    }, l.modules = t, l.cache = s, l.parent = o, l.register = function (e, n) {
        t[e] = [function (t, e) {
            e.exports = n
        }, {}]
    ...
    }), a.parcelRequire93cf = l;
    for (var d = 0; d < e.length; d++) l(e[d]);
    var m = l(n);
    ...
    E13ST: [function (t, e, n) {
        ...
        var r = t("./danmuku"), a = i.interopDefault(r), o = t("./setting"), s = i.interopDefault(o);

        function u(t) {
            return e => {
                !function (t) {
                    const {version: e, utils: {errorHandle: n}} = t.constructor, i = e.split(".").map(Number);
                    n(i[0] + i[1] / 100 >= 4.04, `Artplayer.js@${e} 不兼容该弹幕库，请更新到 4.4.x 版本以上`)
                }(e);
                const n = new a.default(e, t);
        ...
        n.default = u, u.env = "production", u.version = "4.4.1", u.build = "1652773789670", "undefined" != typeof window && (window.artplayerPluginDanmuku = u)
    }, {"./danmuku": "8Gtnh", "@parcel/transformer-js/src/esmodule-helpers.js": "9v6Cv", "./setting": "jAkJm"}],
    "8Gtnh": [function (t, e, n) {
        var i = t("@parcel/transformer-js/src/esmodule-helpers.js");
        i.defineInteropFlag(n);
        var r = t("./bilibili"), a = t("./getDanmuTop"), o = i.interopDefault(a);

        class s {
            constructor(e, n) {
                const {constructor: i, template: r} = e;
            ...
            get marginTop() {
                const {clamp: t} = this.utils, e = this.option.margin[0], {clientHeight: n} = this.$player;
            ...
            get marginBottom() {
                const {clamp: t} = this.utils, e = this.option.margin[1], {clientHeight: n} = this.$player;
                if ("number" == typeof e) return t(e, 0, n);
                if ("string" == typeof e && e.endsWith("%")) {
                    return t(n * (parseFloat(e) / 100), 0, n)
                }
            ...
            getEmits() {
                const t = [], {clientWidth: e} = this.$player, n = this.getLeft(this.$player);
                return this.filter("emit", (i => {
                    const r = i.$ref.offsetTop, a = this.getLeft(i.$ref) - n, o = i.$ref.clientHeight,
                        s = i.$ref.clientWidth, u = a + s, l = e - u, d = u / i.$restTime, m = {};
                    m.top = r, m.left = a, m.height = o, m.width = s, m.right = l, m.speed = d, m.distance = u, m.time = i.$restTime, m.mode = i.mode, t.push(m)
                })), t
            }

            getFontSize(t) {
                const {clamp: e} = this.utils, {clientHeight: n} = this.$player;
            ...
            update() {
                return this.timer = window.requestAnimationFrame((async () => {
                    if (this.art.playing && !this.isHide) {
                        ...
                        const t = this.getReady(), {clientWidth: e, clientHeight: n} = this.$player;
                        for (let i = 0; i < t.length; i++) {
                            ...
                            if (r.$ref) if (this.isStop || void 0 === o) r.$state = "ready", this.$refs.push(r.$ref), r.$ref = null; else switch (r.$state = "emit", r.$ref.style.visibility = "visible", r.mode) {
                                case 0: {
    ...
    KnwDr: [function (t, e, n) {
        ...
        function a(t) {
            ...
            const e = t.match(/<d([\S ]*?>[\S ]*?)<\/d>/gi);
            return e && e.length ? e.map((t => {
                const [, e, n] = t.match(/<d p="(.+)">(.+)<\/d>/), i = e.split(",");
                return 8 === i.length && n.trim() ? {
                    text: n,
                    time: Number(i[0]),
                    mode: r(Number(i[1])),
                    fontSize: Number(i[2]),
    ...
    "2Abxf": [function (t, e, n) {
        t("@parcel/transformer-js/src/esmodule-helpers.js").defineInteropFlag(n), n.default = function ({
            ...
            s.unshift({top: 0, left: 0, right: 0, height: a, width: n, speed: 0, distance: n}), s.push({
                top: i - r,
                left: 0,
                right: 0,
                height: r,
            ...
            for (let e = 1; e < s.length; e += 1) {
                const n = s[e], i = s[e - 1], r = i.top + i.height;
            ...
            for (let t = 1; t < s.length - 1; t += 1) {
                ...
                if (u.length) {
                    ...
                    t[0].top === e.top ? t.push(e) : u.push([e])
                } else u.push([e])
            }
            if (!o) {
                switch (t.mode) {
                    case 0:
                        u.sort(((t, e) => {
                            const n = Math.min(...e.map((t => t.right))), i = Math.min(...t.map((t => t.right)));
    ...
    jAkJm: [function (t, e, n) {
        var i = t("@parcel/transformer-js/src/esmodule-helpers.js");
        i.defineInteropFlag(n);
        var r = t("bundle-text:./style.less"), a = i.interopDefault(r), o = t("bundle-text:./img/danmu-on.svg"),
            s = i.interopDefault(o), u = t("bundle-text:./img/danmu-off.svg"), l = i.interopDefault(u),
            d = t("bundle-text:./img/danmu-config.svg"), m = i.interopDefault(d),
            p = t("bundle-text:./img/danmu-style.svg"), c = i.interopDefault(p);
        if (n.default = function (t, e) {
            const {option: n} = e, {
                template: {$controlsCenter: i, $player: r},
                constructor: {
                    utils: {
                        removeClass: a,
                        addClass: o,
            ...
            function g(t, e) {
                ...
                return u(n, t), o(n, "art-icon"), o(n, `art-icon-${e}`), n
            }

            const k = g(s.default, "danmu-on"), y = g(l.default, "danmu-off"), v = g(m.default, "danmu-config"),
            ...
            function x() {
                const s = ["#FE0302", "#FF7204", "#FFAA02", "#FFD302", "#FFFF00", "#A0EE00", "#00CD00", "#019899", "#4266BE", "#89D5FF", "#CC0273", "#222222", "#9B9B9B", "#FFFFFF"].map((t => `<div class="art-danmuku-style-panel-color${n.color === t ? " art-current" : ""}" data-color="${t}" style="background-color:${t}"></div>`)),
                    l = u(i, `<div class="player-comment-setting-icon danmu-setting-show"></div><div class="art-danmuku-emitter" style="max-width: ${n.maxWidth ? `${n.maxWidth}px` : "100%"}"><div class="art-danmuku-left"><div class="art-danmuku-style"><div class="art-danmuku-style-panel"><div class="art-danmuku-style-panel-inner"><div class="art-danmuku-style-panel-title">模式</div><div class="art-danmuku-style-panel-modes"><div class="art-danmuku-style-panel-mode art-current" data-mode="0">滚动</div><div class="art-danmuku-style-panel-mode" data-mode="1">静止</div></div><div class="art-danmuku-style-panel-title">颜色</div><div class="art-danmuku-style-panel-colors">${s.join("")}</div></div></div></div><input class="art-danmuku-input" maxlength="${n.maxLength}" placeholder="发个弹幕见证当下" /></div><div class="art-danmuku-send">发送</div></div>`),
                    m = h(".art-danmuku-style", l), p = h(".art-danmuku-input", l), c = h(".art-danmuku-send", l),
                    g = h(".art-danmuku-style-panel-inner", l), k = h(".art-danmuku-style-panel-modes", l),
                    y = h(".art-danmuku-style-panel-colors", l);
                t.option.backdrop && o(g, "art-backdrop-filter"), n.theme && o(l, `art-danmuku-theme-${n.theme}`);
                let x = null, w = n.mode, D = n.color;
                function $(t) {
            ...
            t.once("video:loadedmetadata", (() => {
                x(),t.setting.add({
                    ...
                    selector: [{
                        ...
                        icon: "",
                        tooltip: "适中",
                        selector: [{html: "极慢", time: 10}, {html: "较慢", time: 7.5}, {
                            default: !0,
                            html: "适中",
                            time: 5
                        }, {html: "较快", time: 2.5}, {html: "极快", time: 1}],
                        onSelect: function (t) {
                            return e.config({speed: t.time}), t.html
                        }
                    }, {
                        width: 200,
                        html: "字体大小",
                        icon: "",
                        tooltip: "适中",
                        selector: [{html: "极小", fontSize: "2%"}, {html: "较小", fontSize: "4%"}, {
                            default: !0,
                            html: "适中",
                            fontSize: "6%"
                        }, {html: "较大", fontSize: "8%"}, {html: "极大", fontSize: "10%"}],
                        onSelect: function (t) {
                            return e.config({fontSize: t.fontSize}), t.html
                        }
                    }, {
                        width: 200,
                        html: "不透明度",
                        icon: "",
                        tooltip: "100%",
                        selector: [{default: !0, opacity: 1, html: "100%"}, {opacity: .75, html: "75%"}, {
                            opacity: .5,
                            html: "50%"
                        }, {opacity: .25, html: "25%"}, {opacity: 0, html: "0%"}],
                        onSelect: function (t) {
                            return e.config({opacity: t.opacity}), t.html
                        }
                    }, {
                        width: 200,
                        html: "显示范围",
                        icon: "",
                        tooltip: "3/4",
                        selector: [{html: "1/4", margin: [10, "75%"]}, {html: "半屏", margin: [10, "50%"]}, {
                            default: !0,
                            html: "3/4",
                            margin: [10, "25%"]
                        }, {html: "满屏", margin: [10, 10]}],
                        onSelect: function (t) {
                            return e.config({margin: t.margin}), t.html
                        }
                    }, {
                        html: "弹幕防重叠",
                        icon: "",
                        ...
                        onSwitch: t => (e.config({antiOverlap: !t.switch}), t.tooltip = t.switch ? "关闭" : "开启", !t.switch)
                    }, {
                        html: "同步视频速度",
                        icon: "",
                        tooltip: n.synchronousPlayback ? "开启" : "关闭",
                        switch: n.synchronousPlayback,
                        onSwitch: t => (e.config({synchronousPlayback: !t.switch}), t.tooltip = t.switch ? "关闭" : "开启", !t.switch)
                    }]
                })
            }))
